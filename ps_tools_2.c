...
/*   Updated: 2024/01/25 17:20:19 by akovalev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// {
// 	//ft_printf("\nbefore rotate cost total was determined to be %d, and the a index is %d, b index is %d\n", info->cost_min, info->ind_a, info->ind_b);
